...
# SIZE IS CALCULATED AS IN TOTAL BYTES
DEFAULT_CHUNK_SIZE = 5 * 1024 * 1024

# MAXIMUM CHUNK SIZE SERVER WILL HANDLE IN ONE REQUEST
MAXIMUM_CHUNK_SIZE = 64 * 1024 * 1024

# MINIMUM CHUNK SIZE SERVER WILL HANDLE IN ONE REQUEST
MINIMUM_CHUNK_SIZE = 5 * 1024 * 1024

# FOLLOWING IS FOR DEVELOPMENT
# TODO: remove these lines
AUTHENTICATION_URL = 'http://localhost/api/auth/'
FILE_UPLOAD_URL = 'http://localhost/api/upload/'
FILE_UPLOAD_INIT_URL = 'http://localhost/api/upload/init/'
